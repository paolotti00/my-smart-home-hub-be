...
import com.paolotti.my.smart.home.rest.deprecated.IRoomRestController;
...
public class RoomRestControllerImpl extends InterceptorRestControllerExceptionHandler implements IRoomRestController {
    ...
    @Override
    public ResponseEntity<BaseResponseDto<List<DeviceDto>>> getDevices(String roomId) throws ValidationException, RoomNotExistsException {
