...
public interface IRegistrationDeviceService {
    ...
    Device deviceSelfRegisteringHandling(String userId, Device device) throws DeviceAlreadyRegisteredException, MissingFieldException, DeviceCreationException, UserNotExistException;
